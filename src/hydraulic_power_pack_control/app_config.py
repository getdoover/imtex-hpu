...
class HydraulicPowerPackControlConfig(config.Schema):
    def __init__(self):
...
def export():
    HydraulicPowerPackControlConfig().export(Path(__file__).parents[2] / "doover_config.json", "hydraulic_power_pack_control")
