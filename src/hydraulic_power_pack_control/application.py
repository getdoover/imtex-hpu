...
from .app_ui import HydraulicPowerPackControlUI
from .app_state import HydraulicPowerPackControlState

log = logging.getLogger()

class HydraulicPowerPackControlApplication(Application):
    config: HydraulicPowerPackControlConfig  # not necessary, but helps your IDE provide autocomplete!

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.started: float = time.time()
        self.ui: HydraulicPowerPackControlUI = None
        self.state: HydraulicPowerPackControlState = None

    async def setup(self):
        self.ui = HydraulicPowerPackControlUI()
        self.state = HydraulicPowerPackControlState()
